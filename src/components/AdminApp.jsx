import { IndianRupee, Package, Users, CalendarCheck, Wrench, Receipt, Wallet, BarChart3, Truck } from "lucide-react";
...
export default function AdminApp({ tab, setTab, staff, attendance, timeLogs, items, sales, expenses, repairs, refreshAll }) {
  return (
